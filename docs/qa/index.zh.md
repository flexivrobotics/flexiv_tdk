...
## 问：支持哪些平台？
**答：** Ubuntu 22.04+（x86_64 和 aarch64）支持 C++ 和 Python 3.10/3.12/3.14。macOS 14+（arm64）支持 C++ 和 Python 3.10/3.12。工具链要求 GCC ≥ 9.4（Linux）或 Apple Clang ≥ 15（macOS），CMake ≥ 3.16.3。
