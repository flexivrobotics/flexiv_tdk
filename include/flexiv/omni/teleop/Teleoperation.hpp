...
/**
 * @class Teleoperation
 * @brief Main interface with the flexiv_omni_teleop, containing several function categories
...
public:
   ...
   * Teleoperation services will initialize and connection with the robots will be established.
   ...
   */
  Teleoperation(const std::string& localSN, const std::string& remoteSN);
