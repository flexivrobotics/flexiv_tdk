...
public:
  ...
  void SetRepulsiveWrench(
      const std::array<double, flexiv::rdk::kCartDoF>& repulsive_wrench, bool in_world = true);
   ...
   * @return AxisLockStatus
   */
  AxisLockStatus GetLocalAxisLockState(void);
