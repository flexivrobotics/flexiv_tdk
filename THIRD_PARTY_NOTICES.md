...
| --------------------------------------------------------------- | ------- | ------------------------ | -------------------------------------------------------------------------------------------------------------- |
| [spdlog](https://github.com/gabime/spdlog)                      | 1.9.2   | MIT                      | [https://github.com/gabime/spdlog/tree/v1.9.2](https://github.com/gabime/spdlog/tree/v1.9.2)                   |
| [fmt](https://github.com/fmtlib/fmt) (bundled by spdlog)        | 8.0.1   | MIT                      | [https://github.com/fmtlib/fmt](https://github.com/fmtlib/fmt)                                                 |
| [Eclipse zenoh-c](https://github.com/eclipse-zenoh/zenoh-c)     | 1.9.0   | **Apache-2.0 (elected)** | [https://github.com/eclipse-zenoh/zenoh-c/tree/1.9.0](https://github.com/eclipse-zenoh/zenoh-c/tree/1.9.0)     |
| [Eclipse zenoh-cpp](https://github.com/eclipse-zenoh/zenoh-cpp) | 1.9.0   | **Apache-2.0 (elected)** | [https://github.com/eclipse-zenoh/zenoh-cpp/tree/1.9.0](https://github.com/eclipse-zenoh/zenoh-cpp/tree/1.9.0) |
